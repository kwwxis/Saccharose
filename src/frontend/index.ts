...
import './pages/changelog/changelog-textmap-page.ts';
import './pages/changelog/changelog-single-excel-page.ts';
import './pages/changelog/genshin-changelog-summary-page.ts';
