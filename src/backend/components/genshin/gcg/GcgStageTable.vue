<template>
  <table class="article-table">
    ...
    <tbody>
      <tr v-for="stage of stages" style="font-size:15px">
        <td>
          <img v-if="stage?.Reward?.TalkDetailIcon" :src="`/images/genshin/${stage.Reward.TalkDetailIcon.IconName}.png`" class="framed-icon x42" />
        </td>
        <td>
